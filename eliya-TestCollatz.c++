...
TEST(Collatz, eval_5) {
    const int v = collatz_eval(20, 23);
    ASSERT_TRUE(v == 16);}

TEST(Collatz, eval_6) {
    const int v = collatz_eval(15, 19);
    ASSERT_TRUE(v == 21);}
...
TEST(Collatz, print_5) {
    ...
    ASSERT_TRUE(w.str() == "20 23 16\n");}

TEST(Collatz, print_6) {
    std::ostringstream w;
    collatz_print(w, 15, 19, 21);
    ASSERT_TRUE(w.str() == "15 19 21\n");}
