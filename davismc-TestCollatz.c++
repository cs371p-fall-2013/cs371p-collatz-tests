...
/******************************************************************************
 * Program: Project 1: Collatz
 * Student: Merrill Davis
 * CS ID: davismc
 * Class: CS 371p
 * Fall 2013
 *
 * Purpose: unit tests for the collatz 3n+1 problem at spoj.com.  Original code
 *  provided by Glenn Downing.  Completed and optimized by Merrill Davis
 *****************************************************************************/
...
TEST(Collatz, solve_3) {
    ...
    std::ostringstream w;
    collatz_solve(r, w);
    ASSERT_TRUE(w.str() == "11 11 15\n");}

TEST(Collatz, solve_4) {
    std::istringstream r("2 2\n");
    std::ostringstream w;
    collatz_solve(r, w);
    ASSERT_TRUE(w.str() == "2 2 2\n");}
...
TEST(Collatz, cycle_length_3) {
    const int v = collatz_cycle_length(20);
    ASSERT_TRUE(v == 8);}

TEST(Collatz, cycle_length_4) {
    const int v = collatz_cycle_length(16);
    ASSERT_TRUE(v == 5);}
