...
TEST(Collatz, read_2) {
    std::istringstream r("5000 650000\n");
    int i;
    int j;
    const bool b = collatz_read(r, i, j);
    ASSERT_TRUE(b == true);
    ASSERT_TRUE(i ==     5000);
    ASSERT_TRUE(j ==   650000);}

TEST(Collatz, read_3) {
    std::istringstream r("1 25\n");
    int i;
    int j;
    const bool b = collatz_read(r, i, j);
    ASSERT_TRUE(b == true);
...
TEST(Collatz, read_4) {
    std::istringstream r("950000 1000\n");
    int i;
    int j;
    const bool b = collatz_read(r, i, j);
    ASSERT_TRUE(b == true);
    ASSERT_TRUE(i ==     950000);
    ASSERT_TRUE(j ==   1000);}

TEST(Collatz, read_5) {
    std::istringstream r("999999 10\n");
    int i;
    int j;
    const bool b = collatz_read(r, i, j);
    ASSERT_TRUE(b == true);
...
TEST(Collatz, print_2) {
    ...
    ASSERT_FALSE(w.str() == "125 1000 200\n");}
...
TEST(Collatz, print_4) {
    ...
    ASSERT_FALSE(w.str() == "1000 900 174\n");}
